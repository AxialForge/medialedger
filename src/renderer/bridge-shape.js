...
(function (root, shape) {
  ...
  tonight: 'data:tonight', storage: 'data:storage', backupTo: 'db:backupTo', airing: 'data:airing', upgrades: 'data:upgrades', notifyTest: 'notify:test', statusJson: 'data:status', watched: 'data:watched', jobs: { list: 'jobs:list', run: 'jobs:run', overdue: 'jobs:overdue' }, collect: { get: 'collect:get', set: 'collect:set' }, logTail: 'log:tail', restoreList: 'db:restoreList', restoreStage: 'db:restoreStage',
